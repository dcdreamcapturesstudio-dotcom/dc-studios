...
export default function ContactPage() {
  return (
    <div className="bg-neutral-950 min-h-screen text-white overflow-x-hidden font-display selection:bg-white selection:text-black flex flex-col">
      <Header />
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-5/12">
            <Reveal>
              ...
              />
              <p className="text-neutral-400 font-display text-base md:text-xl leading-relaxed max-w-md">
            ...
            <div className="mt-16 space-y-8">
              <Reveal>
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <a href="https://maps.app.goo.gl/oBaRfDJa5qnJ9TUT8" target="_blank" rel="noopener noreferrer" className="text-xs text-neutral-400 hover:text-white flex items-center gap-1 transition-colors">
                      Open in Maps <ArrowUpRight size={14} />
                    </a>
                  </div>
                  <div className="w-full aspect-video rounded-xl overflow-hidden grayscale hover:grayscale-0 transition-all duration-700 border border-neutral-800">
                    <iframe 
              ...
              <Reveal>
                <div>
                  ...
                  <p className="text-neutral-300 text-base md:text-lg">Monday – Friday: 9am to 6pm<br/>Saturday & Sunday: By Appointment Only</p>
                </div>
              </Reveal>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              {socialLinks.map((link, idx) => (
                <Reveal key={idx}>
                  <Link 
                    href={link.url} 
                    className="group flex flex-col md:flex-row md:items-center justify-between p-8 border border-neutral-800 rounded-xl hover:border-neutral-500 hover:bg-neutral-900 transition-all duration-300"
                  >
                    <div>
                      <h3 className="font-serif text-2xl sm:text-3xl md:text-5xl text-white mb-2 group-hover:text-neutral-300 transition-colors">
                        {link.platform}
                      </h3>
                    ...
                    <div className="mt-6 md:mt-0 w-12 h-12 rounded-full border border-neutral-700 flex items-center justify-center group-hover:bg-white group-hover:text-black group-hover:border-white transition-all duration-300">
